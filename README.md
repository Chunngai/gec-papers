...
+ **ChatBack: Investigating Methods of Providing Grammatical Error Feedback in a GUI-based Language Learning Chatbot**
  + Authors: Kai-Hui Liang, Sam Davidson, Xun Yuan, Shehan Panditharatne, Chun-Yen Chen, Ryan Shea, Derek Pham, Yinghua Tan, Erik Voss, Luke Fryer
  + Conference: ACL
  + Link: https://aclanthology.org/2023.bea-1.7/
...
+ **Reference Matters: Benchmarking Factual Error Correction for Dialogue Summarization with Fine-grained Evaluation Framework**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/2023.acl-long.779/
...
+ **Text-to-SQL Error Correction with Language Models of Code**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/2023.acl-short.117/
...
+ **Zero-shot Faithful Factual Error Correction**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/2023.acl-long.311/
...
+ **Optimized Tokenization for Transcribed Error Correction**
  + Authors: Tomer Wullach, Shlomo Chazan
  + Conference: EMNLP
  + Link: https://aclanthology.org/2023.emnlp-main.802/
...
+ **Unnatural Error Correction: GPT-4 Can Almost Perfectly Handle Unnatural Scrambled Text**
  ...
  + Conference: EMNLP
  + Link: https://aclanthology.org/2023.emnlp-main.550/
...
+ **Whispering LLaMA: A Cross-Modal Generative Error Correction Framework for Speech Recognition**
  + Authors: Srijith Radhakrishnan, Chao-Han Yang, Sumeer Khan, Rohit Kumar, Narsis Kiani, David Gomez-Cabrero, Jesper Tegnér
  + Conference: EMNLP
  + Link: https://aclanthology.org/2023.emnlp-main.618/
...
+ **New Datasets and Controllable Iterative Data Augmentation Method for Code-switching ASR Error Correction**
  + Authors: Zhaohong Wan, Xiaojun Wan, Wei Peng, Rongjun Li
  + Conference: EMNLP Findings
  + Link: https://aclanthology.org/2023.findings-emnlp.543/
...
+ **PivotFEC: Enhancing Few-shot Factual Error Correction with a Pivot Task Approach using Large Language Models**
  ...
  + Conference: EMNLP Findings
  + Link: https://aclanthology.org/2023.findings-emnlp.667/
...
+ **Template-guided Grammatical Error Feedback Comment Generation**
  + Authors: Steven Coyne
  + Conference: EACL
  + Link: https://aclanthology.org/2023.eacl-srw.10/
...
+ **A distantly supervised Grammatical Error Detection/Correction system for Swedish**
  ...
  + Conference: WS
  + Link: https://aclanthology.org/2023.nlp4call-1.4/
...
+ **CCL23-Eval 任务7系统报告:基于序列标注和指针生成网络的语法纠错方法(System Report for CCL23-Eval Task 7:A Syntactic Error Correction Approach Based on Sequence Labeling and Pointer Generation Networks)**
  + Authors: Youren Yu (于右任), Yangsen Zhang (张仰森), Guanguang Chang (畅冠光), Beibei Gao (高贝贝), Yushan Jiang (姜雨杉), Tuo Xiao (肖拓)
  + Conference: CCL
  + Link: https://aclanthology.org/2023.ccl-3.26/
...
+ **Comprehensive Evaluation of Translation Error Correction Models**
  + Authors: Masatoshi Otake, Yusuke Miyao
  + Conference: PACLIC
  + Link: https://aclanthology.org/2023.paclic-1.86/

+ **DaLAJ-GED - a dataset for Grammatical Error Detection tasks on Swedish**
  + Authors: Elena Volodina, Yousuf Ali Mohammed, Aleksandrs Berdicevskis, Gerlof Bouma, Joey Öhman
  + Conference: WS
  + Link: https://aclanthology.org/2023.nlp4call-1.11/
...
+ **EliCoDe at MultiGED2023: fine-tuning XLM-RoBERTa for multilingual grammatical error detection**
  + Authors: Davide Colla, Matteo Delsanto, Elisa Di Nuovo
  + Conference: WS
  + Link: https://aclanthology.org/2023.nlp4call-1.3/
...
+ **MultiGED-2023 shared task at NLP4CALL: Multilingual Grammatical Error Detection**
  + Authors: Elena Volodina, Christopher Bryant, Andrew Caines, Orphée De Clercq, Jennifer-Carmen Frey, Elizaveta Ershova, Alexandr Rosen, Olga Vinogradova
  + Conference: WS
  + Link: https://aclanthology.org/2023.nlp4call-1.1/

+ **NTNU-TRH system at the MultiGED-2023 Shared on Multilingual Grammatical Error Detection**
  + Authors: Lars Bungum, Björn Gambäck, Arild Brandrud Næss
  + Conference: WS
  + Link: https://aclanthology.org/2023.nlp4call-1.2/

+ **Speech-Aware Multi-Domain Dialogue State Generation with ASR Error Correction Modules**
  + Authors: Ridong Jiang, Wei Shi, Bin Wang, Chen Zhang, Yan Zhang, Chunlei Pan, Jung Jae Kim, Haizhou Li
  + Conference: WS
  + Link: https://aclanthology.org/2023.dstc-1.13/

+ **System Report for CCL23-Eval Task 7: Chinese Grammatical Error Diagnosis Based on Model Fusion**
  + Authors: Yanmei Ma, Laiqi Wang, Zhenghua Chen, Yanran Zhou, Ya Han, Jie Zhang
  + Conference: CCL
  + Link: https://aclanthology.org/2023.ccl-3.28/
...
+ **Two Neural Models for Multilingual Grammatical Error Detection**
  + Authors: Phuong Le-Hong, The Quyen Ngo, Thi Minh Huyen Nguyen
  + Conference: WS
  + Link: https://aclanthology.org/2023.nlp4call-1.5/
...
+ **Factual Error Correction for Abstractive Summaries Using Entity Retrieval**
  ...
  + Conference: EMNLP
  + Link: https://aclanthology.org/2022.gem-1.41/
...
+ **An Error-Guided Correction Model for Chinese Spelling Error Correction**
  ...
  + Conference: EMNLP Findings
  + Link: https://aclanthology.org/2022.findings-emnlp.278/
...
+ **Non-Autoregressive Chinese ASR Error Correction with Phonological Training**
  + Authors: Zheng Fang, Ruiqing Zhang, Zhongjun He, Hua Wu, Yanan Cao
  + Conference: NAACL
  + Link: https://aclanthology.org/2022.naacl-main.432/
...
+ **Probing for targeted syntactic knowledge through grammatical error detection**
  ...
  + Conference: CoNLL
  + Link: https://aclanthology.org/2022.conll-1.25/
...
+ **Error Correction Environment for the Polish Parliamentary Corpus**
  + Authors: Maciej Ogrodniczuk, Michał Rudolf, Beata Wójtowicz, Sonia Janicka
  + Conference: LREC
  + Link: https://aclanthology.org/2022.parlaclarin-1.6/
...
+ **Swedish MuClaGED: A new dataset for Grammatical Error Detection in Swedish**
  + Authors: Judith Casademont Moner, Elena Volodina
  + Conference: WS
  + Link: https://aclanthology.org/2022.nlp4call-1.4/
...
+ **Evidence-based Factual Error Correction**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/2021.acl-long.256/
...
+ **Global Attention Decoder for Chinese Spelling Error Correction**
  + Authors: Zhao Guo, Yuan Ni, Keqiang Wang, Wei Zhu, Guotong Xie
  + Conference: ACL Findings
  + Link: https://aclanthology.org/2021.findings-acl.122/
...
+ **Hierarchical Character Tagger for Short Text Spelling Error Correction**
  ...
  + Conference: EMNLP
  + Link: https://aclanthology.org/2021.wnut-1.13/
...
+ **Self-Supervised Curriculum Learning for Spelling Error Correction**
  ...
  + Conference: EMNLP
  + Link: https://aclanthology.org/2021.emnlp-main.281/
...
+ **Unsupervised Multi-View Post-OCR Error Correction With Language Models**
  ...
  + Conference: EMNLP
  + Link: https://aclanthology.org/2021.emnlp-main.680/
...
+ **FastCorrect 2: Fast Error Correction on Multiple Candidates for Automatic Speech Recognition**
  + Authors: Yichong Leng, Xu Tan, Rui Wang, Linchen Zhu, Jin Xu, Wenjie Liu, Linquan Liu, Xiang-Yang Li, Tao Qin, Edward Lin, Tie-Yan Liu
  + Conference: EMNLP Findings
  + Link: https://aclanthology.org/2021.findings-emnlp.367/
...
+ **Visual Cues and Error Correction for Translation Robustness**
  ...
  + Conference: EMNLP Findings
  + Link: https://aclanthology.org/2021.findings-emnlp.271/
...
+ **ELERRANT: Automatic Grammatical Error Type Classification for Greek**
  + Authors: Katerina Korre, Marita Chatzipanagiotou, John Pavlopoulos
  + Conference: RANLP
  + Link: https://aclanthology.org/2021.ranlp-1.81/
...
+ **On the Robustness of Language Encoders against Grammatical Errors**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/2020.acl-main.310/

+ **Spelling Error Correction with Soft-Masked BERT**
  + Authors: Shaohua Zhang, Haoran Huang, Jicong Liu, Hang Li
  + Conference: ACL
  + Link: https://aclanthology.org/2020.acl-main.82/

+ **Towards Understanding ASR Error Correction for Medical Conversations**
  + Authors: Anirudh Mani, Shruti Palaskar, Sandeep Konam
  + Conference: ACL
  + Link: https://aclanthology.org/2020.nlpmc-1.2/

+ **Factual Error Correction for Abstractive Summarization Models**
  + Authors: Meng Cao, Yue Dong, Jiapeng Wu, Jackie Chi Kit Cheung
  + Conference: EMNLP
  + Link: https://aclanthology.org/2020.emnlp-main.506/
...
+ **CYUT Team Chinese Grammatical Error Diagnosis System Report in NLPTEA-2020 CGED Shared Task**
  + Authors: Shih-Hung Wu, Junwei Wang
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.12/
...
+ **Chinese Grammatical Error Diagnosis Based on RoBERTa-BiLSTM-CRF Model**
  + Authors: Yingjie Han, Yingjie Yan, Yangchao Han, Rui Chao, Hongying Zan
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.13/

+ **Chinese Grammatical Error Diagnosis with Graph Convolution Network and Multi-task Learning**
  + Authors: Yikang Luo, Zuyi Bao, Chen Li, Rui Wang
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.6/

+ **Chinese Grammatical Errors Diagnosis System Based on BERT at NLPTEA-2020 CGED Shared Task**
  + Authors: Hongying Zan, Yangchao Han, Haotian Huang, Yingjie Yan, Yuke Wang, Yingjie Han
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.14/

+ **Combining ResNet and Transformer for Chinese Grammatical Error Diagnosis**
  + Authors: Shaolei Wang, Baoxin Wang, Jiefu Gong, Zhongyuan Wang, Xiao Hu, Xingyi Duan, Zizhuo Shen, Gang Yue, Ruiji Fu, Dayong Wu, Wanxiang Che, Shijin Wang, Guoping Hu, Ting Liu
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.5/
...
+ **Correct Me If You Can: Learning from Error Corrections and Markings**
  ...
  + Conference: EAMT
  + Link: https://aclanthology.org/2020.eamt-1.15/
...
+ **Correcting the Autocorrect: Context-Aware Typographical Error Correction via Training Data Augmentation**
  ...
  + Conference: LREC
  + Link: https://aclanthology.org/2020.lrec-1.856/
...
+ **Integrating BERT and Score-based Feature Gates for Chinese Grammatical Error Diagnosis**
  + Authors: Yongchang Cao, Liang He, Robert Ridley, Xinyu Dai
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.7/
...
+ **Overview of NLPTEA-2020 Shared Task for Chinese Grammatical Error Diagnosis**
  + Authors: Gaoqi Rao, Erhong Yang, Baolin Zhang
  + Conference: AACL
  + Link: https://aclanthology.org/2020.nlptea-1.4/
...
+ **An Analysis of Source-Side Grammatical Errors in NMT**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W19-4822/
...
+ **Context is Key: Grammatical Error Detection with Contextual Word Representations**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W19-4410/
...
+ **Multi-headed Architecture Based on BERT for Grammatical Errors Correction**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W19-4426/
...
+ **基於Seq2Seq模型的中文文法錯誤診斷系統(A Chinese Grammatical Error Diagnosis System Based on Seq2Seq Model)**
  + Authors: Jun-Wei Wang, Sheng-Lun Chien, Yi-Kun Chen, Shih-Hung Wu
  + Conference: ROCLING
  + Link: https://aclanthology.org/2019.rocling-1.33/
...
+ **A Hybrid Approach Combining Statistical Knowledge with Conditional Random Fields for Chinese Grammatical Error Detection**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W18-3728/
...
+ **CMMC-BDRC Solution to the NLP-TEA-2018 Chinese Grammatical Error Diagnosis Task**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W18-3726/
...
+ **Detecting Grammatical Errors in the NTOU CGED System by Identifying Frequent Subsentences**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W18-3730/
...
+ **Overview of NLPTEA-2018 Share Task Chinese Grammatical Error Diagnosis**
  ...
  + Conference: ACL
  + Link: https://aclanthology.org/W18-3706/
...
+ **Automated Error Correction and Validation for POS Tagging of Hindi**
  ...
  + Conference: PACLIC
  + Link: https://aclanthology.org/Y18-1002/

+ **Automatic Error Correction on Japanese Functional Expressions Using Character-based Neural Machine Translation**
  + Authors: Jun Liu, Fei Cheng, Yiran Wang, Hiroyuki Shindo, Yuji Matsumoto
  + Conference: PACLIC
  + Link: https://aclanthology.org/Y18-1046/
...
+ **Building a TOCFL Learner Corpus for Chinese Grammatical Error Diagnosis**
  ...
  + Conference: LREC
  + Link: https://aclanthology.org/L18-1363/
